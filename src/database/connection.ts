...
const INIT_SQL_PATH = path.join(process.cwd(), 'src', 'database', 'init.sql');
const MIGRATION_SQL_PATH = path.join(process.cwd(), 'src', 'database', 'comment_migration.sql');
const SYSTEM_SETTINGS_MIGRATION_PATH = path.join(process.cwd(), 'src', 'database', 'system_settings_migration.sql');
const LIKES_MIGRATION_PATH = path.join(process.cwd(), 'src', 'database', 'likes_migration.sql');
const ADMIN_MIGRATION_PATH = path.join(process.cwd(), 'src', 'database', 'admin_migration.sql');
